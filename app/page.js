...
const translations = {
    bn: {
        ...
        statusPending: "পেন্ডিং", statusSolved: "সমাধান হয়েছে", logout: "লগআউট",
    ...
    en: {
        ...
        statusPending: "Pending", statusSolved: "Solved", logout: "Logout",
...
export default function TaskBazarApp() {
    ...
    // Change View logic with Intercept for 'support-view'
    const handleSetView = (newView) => {
        // যদি support-view (অভিযোগ) এ ক্লিক করা হয়, তাহলে complaint পেজে নিয়ে যাবে
        if (newView === 'support-view') {
    ...
    useEffect(() => {
        ...
        return () => {
            unsubStats(); unsubPubNotif(); unsubPvtNotif();
        };
    }, [user]);
