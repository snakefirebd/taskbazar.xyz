...
export default function ManageTasksPage() {
    ...
    const [view, setView] = useState('manage-view'); // Custom view state for footer logic
    ...
    return (
        <>
            ...
            {/* Special Menu Style Fix for 'Manage' since it's only on this page */}
            {/* The Expanded Menu should have 'Manage' highlighted. Adding logic to Footer manually for this page only if needed */}
            <style>{`
                 /* If user is in manage view, let's keep the manage icon highlighted in expanded menu */
                 .hf-expanded-menu .hf-nav-item:first-child .hf-nav-item-icon-box { background: #fef2f2 !important; color: #ef4444 !important; }
            `}</style>
